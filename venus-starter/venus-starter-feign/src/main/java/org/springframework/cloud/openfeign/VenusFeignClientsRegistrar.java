...
import com.junmoyu.venus.cloud.starter.feign.VenusFeignAutoConfiguration;
 ...
 * @date 2021/12/25
 */
public class VenusFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return VenusFeignAutoConfiguration.class;
    }
